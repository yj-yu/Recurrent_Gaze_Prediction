    ...
    def create_shallownet(images, scope=None, net=None, dropout=True):
        ...
        with tf.variable_scope(scope or 'ShallowNet'):
            ...
            net['conv1'] = convolution2d(images, 32,
                                        ...
                                        weights_initializer=initializers.xavier_initializer_conv2d(uniform=True),
            ...
            net['conv3'] = convolution2d(net['pool2'], 32,
                                        kernel_size=(3, 3), stride=(1, 1), padding='VALID',
                                        activation_fn=None,#tf.nn.relu,
                                        weights_initializer=initializers.xavier_initializer_conv2d(uniform=True),
                                        biases_initializer=tf.constant_initializer(0.0),
            ...
            fc1_slice1, fc1_slice2 = tf.split(net['fc1'],num_or_size_splits = 2, axis = 1, name='fc1_slice') #syntax probably wrong here for newer tensorflow version
            ...
            fc2_slice1, fc2_slice2 = tf.split(net['fc2'],num_or_size_splits = 2, axis = 1, name='fc2_slice')
